...
//            0);
    ...
    private void startLoadingAnimation() {
        ...
        mAnimation.addFrame(getDrawable(R.mipmap.ic_loading_msgplus_01), 300);
        mAnimation.addFrame(getDrawable(R.mipmap.ic_loading_msgplus_02), 300);
        mAnimation.addFrame(getDrawable(R.mipmap.ic_loading_msgplus_03), 300);
        mAnimation.addFrame(getDrawable(R.mipmap.ic_loading_msgplus_04), 300);
